...
module.exports.sendWhatsappMessage = (toMobileNo, template) => {
    return new Promise(async(resolve, reject) => {
        try {
            ...
            let headers = {
                'Authorization': 'Bearer EAANE47CvoO4BAG9nZCt7kOk47nVCUFvRe9RceGdvWLZAYAueAZCb3m7QpoF938dhTFr6XhZBBltLKz1hUfRyYioUeHXRvZBSARGsaru7fuTvmc4ZC4Hybprt1Ozc1QNifoXcrGUUAXUJs2iyXHbQlvZBif77ScHCdA5hpxj3oj5ZAv1xREYVDeOm',
